  ...
  categories: [
    {
      ...
      name: "North Indian",
      image:
        "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/v1674029845/PC_Creative%20refresh/3D_bau/banners_new/North_Indian.png",
...

    {
      ...
      link: "https://www.swiggy.com/search?query=Rolls",
    },
    {
      id: 6,
      name: "Chinese",
      ...
      link: "https://www.swiggy.com/search?query=Chinese",
    },
  ],
  restaurants: [
    {
    ...
    },
    {
      ...
      menu: [
        ...
        },
        {
          ...
          price: 289,
          isVeg: true,
          desc: "Cottage cheese cubes in spicy gravy.",
        },
        {
          id: "m6",
          name: "Garlic Naan",
          price: 45,
          isVeg: true,
          desc: "Soft flatbread flavored with garlic.",
        },
      ],
    },
    {
      ...
      menu: [
        {
          ...
          price: 120,
          isVeg: false,
          desc: "Steamed dumplings filled with minced chicken.",
        },
        {
          id: "m8",
        ...
        },
        {
          ...
          price: 220,
          isVeg: false,
          desc: "Spicy, crispy chicken tossed in soy sauce.",
        },
      ],
    },
    {
      ...
      menu: [
        ...
        },
        {
          ...
          price: 350,
          isVeg: false,
          desc: "Rich and flavorful mutton biryani.",
        },
        {
          id: "m12",
          name: "Veg Biryani",
          price: 180,
          isVeg: true,
          desc: "Mixed vegetable biryani served with raita.",
        },
      ],
    },
    {
      ...
      menu: [
        ...
        },
        {
          ...
          price: 89,
          isVeg: true,
          desc: "Crunchy vegetable patty with mayo.",
        },
        {
          id: "m15",
          ...
          price: 119,
          isVeg: true,
          desc: "Crispy golden completely salted fries.",
        },
      ],
    },
    {
      ...
      menu: [
        {
          ...
          price: 220,
          isVeg: true,
          desc: "Fresh cucumbers, olives, feta cheese and vinaigrette.",
        },
        {
          id: "m17",
          name: "Caesar Salad",
          price: 210,
          isVeg: true,
          desc: "Lettuce, croutons, and parmesan cheese.",
        },
        {
          id: "m18",
          name: "Avocado Toast",
          price: 190,
          isVeg: true,
          desc: "Mashed avocado on toasted sourdough.",
        },
      ],
    },
    {
      ...
      menu: [
        {
          ...
          price: 110,
          isVeg: true,
          desc: "Crispy shell filled with yogurt, chutneys and sprouts.",
        },
        {
          id: "m23",
          name: "Chole Bhature",
    ...
    },
    {
      ...
      name: "Subway",
      image:
        "https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?auto=format&fit=crop&q=80&w=400",
      rating: 4.1,
      eta: "20-30 mins",
      ...
      menu: [
        {
          ...
          price: 210,
          isVeg: false,
          desc: "Tender chicken strips with fresh veggies.",
        },
        {
          id: "m26",
          ...
          price: 180,
          isVeg: true,
          desc: "Classic combination of lettuce, tomatoes, and green peppers.",
        },
        {
          id: "m27",
          ...
          price: 50,
          isVeg: true,
          desc: "Fresh baked sweet chocolate chip cookie.",
        },
      ],
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1556740758-90de374c12ad?auto=format&fit=crop&q=80&w=400",
      rating: 4.6,
      eta: "15-20 mins",
      ...
      menu: [
        {
          ...
          price: 295,
          isVeg: true,
          desc: "Coffee blended with chocolate chips and milk.",
        },
        {
          id: "m29",
          ...
          price: 325,
          isVeg: true,
          desc: "Rich mocha syrup with cookie crumbles.",
        },
        {
          id: "m30",
          ...
          price: 185,
          isVeg: false,
          desc: "Flaky and buttery layered pastry.",
        },
      ],
    },
    {
      ...
      name: "Wow! Momo",
      image:
        "https://images.unsplash.com/photo-1625937286074-9ca519d5d9df?auto=format&fit=crop&q=80&w=400",
      rating: 4.2,
      eta: "30-40 mins",
      ...
      menu: [
        {
          ...
          price: 199,
          isVeg: false,
          desc: "Spicy pan fried dumplings in schezwan sauce.",
        },
        {
          id: "m32",
          name: "Veg Darjeeling Momos",
          price: 129,
          isVeg: true,
          desc: "Authentic steamed vegetable momos.",
        },
        {
          id: "m33",
          name: "Moburg",
          price: 89,
          isVeg: false,
          desc: "Fried momos packed inside a burger bun.",
        },
      ],
    },
    {
      ...
      name: "Nirula's",
      image:
        "https://images.unsplash.com/photo-1557142046-c704a3adf364?auto=format&fit=crop&q=80&w=400",
      rating: 4.0,
      eta: "35-45 mins",
      ...
      menu: [
        {
          ...
          price: 250,
          isVeg: true,
          desc: "Vanilla ice cream with nuts and hot chocolate fudge.",
        },
        {
          id: "m35",
          name: "Nutty Buddy",
          price: 160,
          isVeg: true,
          desc: "Crunchy waffle cone loaded with nuts.",
        },
        {
          id: "m36",
          ...
          price: 195,
          isVeg: true,
          desc: "Thick and creamy classic strawberry milkshake.",
        },
      ],
    },
  ],
